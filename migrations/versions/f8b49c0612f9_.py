...
Revision ID: f8b49c0612f9
Revises: 3a4613a580c1
Create Date: 2022-08-20 13:15:47.302806
...
revision = 'f8b49c0612f9'
down_revision = '3a4613a580c1'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('show_start_time', sa.DateTime(timezone=True), nullable=True),
